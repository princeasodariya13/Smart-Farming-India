        ...
        <section className="hidden md:flex w-1/2 bg-gradient-to-br from-[#0d631b] to-[#1b6d24] relative flex-col justify-between p-12 text-white">
          ...
          >
            <div className="flex -space-x-3 shrink-0">
              <img className="w-10 h-10 rounded-full border-2 border-primary object-cover" width={40} height={40} loading="lazy" decoding="async" alt="Registered farmer profile avatar 1" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBgNUT1VOI4HsoAx8rAvO3BQWCFjP-ohqow9-ZWnJtpUqlmidTIoMrBc6rKnbVMrosMJAFbrF3El7hGoj8FmXnJUHLH1qR0qg8W3CWfradvT11OQKMbVgkJv5JZm1LB4A9_loELPHpUbEsOPWT6mkY71IlrogQWI7zSwHh_lrmwwPXPmCTtdk-QlMCV7eEEI8Rq_2s36QwdTWT37KkDYzfa-3BiTpu6O5xTwpsbLcSesA5iWWLwdfkw_wL1hgR2giknpt4n65xUrQ"/>
              <img className="w-10 h-10 rounded-full border-2 border-primary object-cover" width={40} height={40} loading="lazy" decoding="async" alt="Registered farmer profile avatar 2" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAry1mSLERN1Ct8oshbkECVA8J3FYCPz4XSSAHKnscnd9W3LmmTqLzCL0p18hlaP9d7Ev2RRR2YHd4-8Wh3nVDMF_PHZXobq3I5siWJt7H3A-qWShUga8VYGAcuFuxwuor4chokC5ELoun7fJ_qgWQ_Lp3Zs4GMOAfclrdWHRwD8IPenqSCAvUNV5mWbH8NJokb_qimayHnGROG3RjVGtSAR8d2cly5Ca4s0R4rN2WNVl_HbjeanzFAk7mWPY9CQZ6aCiZuol9JgQ"/>
              <img className="w-10 h-10 rounded-full border-2 border-primary object-cover" width={40} height={40} loading="lazy" decoding="async" alt="Registered farmer profile avatar 3" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDqYdwCPxiyuWjD5zii4zV052axR04bqpcrzWbziualpu50foayZUGWWGdpfYQec57wNFJdr2PokOd-h4Y0PpF34oYuqwmfk-gIT8yJ3EYyWi7zKb-MnpEjVYLTUYH6GGiPdwUj1JiuUr6giKR7cyh3HIuwHo78CVr5nYLtD-2zuoQoJsvIvK-HBryIQi49eXsYAovRRvlW4FWuQ22kBb02OFSeOHuo7gza2mzIXOHSV9Ov91Ayze8Ck5qV82gk5saJ7bqiytg18A"/>
            </div>
            <div>
