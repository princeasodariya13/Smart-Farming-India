        ...
        <div className="relative z-10 mt-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg text-slate-300 max-w-md leading-relaxed mb-12">
              Access AI disease detection, live market prices, equipment rental, and all your farming tools in one unified enterprise platform.
            </p>
          </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 xl:p-24 relative bg-slate-50">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold text-green-600 hover:text-green-700">Forgot password?</Link>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-green-600 transition-colors">
                  <Lock size={18} />
            ...
            <div className="flex items-center pb-2">
              ...
              />
              <label htmlFor="remember" className="ml-2 text-sm text-slate-600 font-medium cursor-pointer">Remember me for 30 days</label>
            </div>

            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 bg-green-600 text-white py-3.5 rounded-xl font-bold hover:bg-green-700 hover:shadow-lg hover:shadow-green-600/20 transition-all disabled:opacity-70 disabled:hover:shadow-none"
            >
              {isLoading ? (
          ...
          <p className="mt-8 text-center text-sm text-slate-600 font-medium">
            Don't have an account? <Link href="/signup" className="text-green-600 hover:text-green-700 font-bold hover:underline">Sign up for free</Link>
          </p>
        </div>
      </div>
    </div>
