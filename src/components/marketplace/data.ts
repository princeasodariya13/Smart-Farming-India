...
export const CATEGORIES: Category[] = [
  { id: "all", label: "All Items", icon: "agriculture" },
  { id: "equipment", label: "Equipment", icon: "precision_manufacturing", count: 24 },
  { id: "supplies", label: "Farm Supplies", icon: "eco", count: 158 },
  { id: "rental", label: "Rental", icon: "event_repeat", count: 12 },
  { id: "seeds", label: "Seeds", icon: "grass", count: 43 },
  { id: "fertilizers", label: "Fertilizers", icon: "science", count: 67 },
  { id: "irrigation", label: "Irrigation", icon: "water_drop", count: 31 },
  { id: "smart", label: "Smart Devices", icon: "sensors", count: 18 },
];
